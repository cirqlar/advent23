...
fn process(input: &str) -> usize {
    ...
    let result = dijkstra(
        ...
        |n| {
            ...
            } else if n.dir.is_some() {
                new_dirs = vec![n.dir.unwrap()];
            }
            ...
            new_dirs
                ...
                .filter_map(|dir| {
                    ...
                    if n.count >= 10 && dir == n.dir.unwrap() {
                        return None;
                    }
